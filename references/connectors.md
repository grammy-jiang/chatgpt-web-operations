...
- Listing: `POST /backend-api/aip/connectors/links/list_accessible`; refresh tools: `POST /backend-api/aip/connectors/mcp/refresh_actions` (already in chatgpt-web-operations).
